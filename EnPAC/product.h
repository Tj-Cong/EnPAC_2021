...
#ifndef ENPAC_PRODUCT_H
#define ENPAC_PRODUCT_H
...
//            cout << "FORMULA " + propertyid + " " + re + " TECHNIQUES"+nupn+safe+pinvar+longbitplace;
    ...
    {
        cout<<"FORMULA "+propertyid+" "+"CANNOT_COMPUTE_MEMORY_OVERFLOW";
        ret = -1;
    }
    else if(!stack_flag)
    {
        cout<<"FORMULA "+propertyid+" "+"CANNOT_COMPUTE_STACK_OVERFLOW";
        ret = -1;
    }
    else if(!data_flag)
    {
        cout<<"FORMULA "+propertyid+" "+"CANNOT_COMPUTE_DATA_OVERFLOW";
        ret = -1;
    }
    else if(!consistency_flag)
    {
        cout<<"FORMULA "+propertyid+" "+"CANNOT_COMPUTE_CONSISTENCY_ERROR";
        ret = -1;
    }
    else if(!timeflag)
    {
        cout<<"FORMULA "+propertyid+" "+"CANNOT_COMPUTE_TIME_RUNOUT";
        ret = -1;
    }
